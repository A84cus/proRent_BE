/*
  ...
  - The values [WAITING_PAYMENT,WAITING_CONFIRMATION] on the enum `Status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Prorent"."Status_new" AS ENUM ('DRAFT', 'PENDING_PAYMENT', 'PENDING_CONFIRMATION', 'CONFIRMED', 'CANCELLED');
