...
export async function createXenditInvoice (paymentId: string) {
   ...
   const invoiceData = {
      ...
      success_return_url: `${BASE_FE_URL || BASE_FE_URL_ALT}/payment/success?reservationId=${reservation.id}`,
      failure_return_url: `${BASE_FE_URL || BASE_FE_URL_ALT}/payment/failure?reservationId=${reservation.id}`
   };

   try {
      console.log(
         'DEBUG: success_redirect_url:',
         `${BASE_FE_URL || BASE_FE_URL_ALT}/payment/success?reservationId=${reservation.id}`
      );
      console.log(
         'DEBUG: failure_redirect_url:',
