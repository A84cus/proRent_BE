...
class EmailService {
  ...
  async sendBookingRejection(
    ...
    try {
      const htmlContent = createPaymentProofRejectionTemplate(
        user,
        bookingDetails
      );
  ...
  async sendBookingCancelationByUser(
    user: UserWithProfile,
    bookingDetails: BookingDetails
  ): Promise<void> {
    try {
      const htmlContent = createBookingCancellationByUserTemplate(
        user,
        bookingDetails
      );
  ...
  async sendBookingCancelationByOwner(
    user: UserWithProfile,
    bookingDetails: BookingDetails
  ): Promise<void> {
    try {
      const htmlContent = createBookingCancellationByOwnerTemplate(
        user,
        bookingDetails
      );
