...
export const PROPERTY_ERROR_MESSAGES = {
  ...
  PROPERTY_NOT_FOUND_OR_NO_UPDATE_PERMISSION:
    "Property not found or you don't have permission to update it",
  PROPERTY_NOT_FOUND_OR_NO_DELETE_PERMISSION:
  ...
  IS_AVAILABLE_REQUIRED_AT_INDEX:
  ...
  CANNOT_DELETE_PROPERTY_WITH_ACTIVE_BOOKINGS:
  ...
  RATE_TYPE_REQUIRED:
    "Rate type is required and must be either FIXED or PERCENTAGE",
  ...
  UPDATED_DATE_RANGE_OVERLAP:
    "Updated date range would overlap with existing rate rules",
  NO_PERMISSION_MANAGE_ROOM_PRICING:
  ...
  CANNOT_SET_UNAVAILABLE_DATES_WITH_RESERVATIONS:
    "Cannot set unavailable dates that have active reservations",
...
export const PROPERTY_SUCCESS_MESSAGES = {
  ...
  PEAK_RATE_REMOVED:
    "Peak rate removed successfully. Room will revert to base price for this period.",
...
export type PropertyErrorMessage =
  (typeof PROPERTY_ERROR_MESSAGES)[keyof typeof PROPERTY_ERROR_MESSAGES];

export type PropertySuccessMessage =
  (typeof PROPERTY_SUCCESS_MESSAGES)[keyof typeof PROPERTY_SUCCESS_MESSAGES];
