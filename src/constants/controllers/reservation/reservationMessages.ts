...
export type ReservationErrorMessage = typeof RESERVATION_ERROR_MESSAGES[keyof typeof RESERVATION_ERROR_MESSAGES];

export type ReservationSuccessMessage = typeof RESERVATION_SUCCESS_MESSAGES[keyof typeof RESERVATION_SUCCESS_MESSAGES];
