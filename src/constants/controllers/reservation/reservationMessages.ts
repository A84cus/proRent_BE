...
export const RESERVATION_ERROR_MESSAGES = {
  ...
  UNEXPECTED_ERROR_PROCESSING_EXPIRED:
    "An unexpected error occurred while processing expired reservations.",
...
export const RESERVATION_SUCCESS_MESSAGES = {
  ...
  RESERVATION_REJECTED:
    "Reservation rejected successfully. Status changed to PENDING_PAYMENT",
...
export type ReservationErrorMessage =
  (typeof RESERVATION_ERROR_MESSAGES)[keyof typeof RESERVATION_ERROR_MESSAGES];

export type ReservationSuccessMessage =
  (typeof RESERVATION_SUCCESS_MESSAGES)[keyof typeof RESERVATION_SUCCESS_MESSAGES];
