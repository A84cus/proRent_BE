...
export const ROOM_SERVICE_ERRORS = {
  ...
  ROOM_TYPE_NOT_FOUND_OR_NO_PERMISSION:
    "Room type not found or you don't have permission to access it",
...
export const ROOM_TYPE_SERVICE_ERRORS = {
  // Property access errors
  PROPERTY_NOT_FOUND_OR_NO_PERMISSION:
    "Property not found or you don't have permission to access it",
  PROPERTY_NOT_FOUND_OR_NO_CREATE_PERMISSION:
    "Property not found or you don't have permission to create room types for it",

  // Room Type access errors
  ROOM_TYPE_NOT_FOUND: "Room type not found",
  ROOM_TYPE_NOT_FOUND_OR_NO_PERMISSION_UPDATE:
    "Room type not found or you don't have permission to update it",
  ROOM_TYPE_NOT_FOUND_OR_NO_PERMISSION_DELETE:
    "Room type not found or you don't have permission to delete it",
  ...
  ROOM_TYPE_NAME_EXISTS:
    "Room type with this name already exists for this property",

  // Business logic errors
  CANNOT_DELETE_ROOM_TYPE_WITH_ROOMS:
    "Cannot delete room type that has rooms assigned",
