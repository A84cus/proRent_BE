...
export const reviewCreateSchema = z.object({
   propertyId: z.string('Invalid property ID format').length(12),
...
export const reviewQuerySchema = z.object({
   propertyId: z.nanoid('Invalid property ID format').optional(),
   userId: z.nanoid('Invalid user ID format').optional(),
