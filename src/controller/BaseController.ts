...
abstract class BaseController {
   ...
   protected handleError (
      ...
      if (error.message && specificErrors[error.message]) {
         ...
         return ResponseHelper.error(res, specificError.message, undefined, specificError.statusCode);
      }
   ...
   protected handleValidationError (res: Response, error: string | string[]) {
      ...
      return ResponseHelper.error(res, message, Array.isArray(error) ? error : undefined, 400);
   }
