...
import multerConfigService from "../service/multerConfigService";
import responseHelper from "../helpers/responseHelper";
import authorizationHelper from "../helpers/authorizationHelper";
import logger from "../utils/logger";
import { handleUploadError } from "../helpers/errorHandler";
import { uploadFileSchema } from "../validations/utilityValidation";
...
class UploadController {
  ...
  async deleteFile(req: Request, res: Response) {
    try {
      ...
      if (!id) {
        return responseHelper.badRequest(res, "File ID is required");
      }
