...
class UserRepository {
   ...
   async setVerificationToken (id: string, hashedToken: string, expires: Date): Promise<User> {
      return this.update(id, {
         verificationToken: hashedToken,
   ...
   // Set reset token
   async setResetToken (id: string, hashedToken: string, expires: Date): Promise<User> {
      return this.update(id, {
         resetToken: hashedToken,
