// src/templates/report/roomTypeReport.ts
...
export function addRoomTypeSheets (
   ...
   let targetRoomType: ReportInterface.RoomTypeWithAvailability | undefined,
      parentProperty: ReportInterface.PropertyMin | undefined;
   ...
   const sheetName = truncateSheetName(`${targetRoomType.roomType.name} Report`);
   ...
   addReservationsSheet(
      workbook,
      report,
      `All Reservations for ${targetRoomType.roomType.name}`,
      undefined,
      roomTypeId,
      true
   );
