...
exports.addFullOwnerSheets = addFullOwnerSheets;
...
function addFullOwnerSheets(workbook, report) {
    // Add a sheet for each property
    report.properties.forEach(p => {
        const sheetName = (0, helper_1.truncateSheetName)(p.property.name);
    ...
    (0, helper_1.addReservationsSheet)(workbook, report, 'All Reservations', undefined, undefined, true);
}
