...
exports.createPaymentProofRejectionTemplate = void 0;
const config_1 = require("../../config");
const createPaymentProofRejectionTemplate = (user, bookingDetails) => {
    var _a, _b, _c, _d;
    ...
    <body>
      ...
      <div class="content">
        <p>Hi ${fullName},</p>
        <p>We've reviewed your payment proof for reservation <strong>${bookingDetails.id}</strong>, but unfortunately, we need to request a new upload.</p>
        ...
        <a href="${process.env.FRONTEND_URL || 'prorent-fe.vercel.app'}/payment/${bookingDetails.id}" class="btn">Reupload Payment Proof</a>
...
exports.createPaymentProofRejectionTemplate = createPaymentProofRejectionTemplate;
