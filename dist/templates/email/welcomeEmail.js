...
exports.createWelcomeEmailTemplate = void 0;
const createWelcomeEmailTemplate = (user, dashboardUrl) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>Thank you for choosing ProRent. We're here to make your ${user.role === "TENANT" ? "property rental" : "accommodation search"} experience amazing!</p>
