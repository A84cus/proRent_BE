...
function createXenditInvoice(paymentId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const invoiceData = {
            ...
            success_return_url: `${index_1.BASE_FE_URL || index_1.BASE_FE_URL_ALT}/payment/success?reservationId=${reservation.id}`,
            failure_return_url: `${index_1.BASE_FE_URL || index_1.BASE_FE_URL_ALT}/payment/failure?reservationId=${reservation.id}`
        };
        try {
