...
const roomServiceErrors_1 = require("../constants/roomServiceErrors");
class RoomService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error instanceof Error &&
                    error.message === roomServiceErrors_1.ROOM_SERVICE_ERRORS.PROPERTY_NOT_FOUND_OR_NO_PERMISSION) {
                    throw error;
                }
    ...
    deleteRoom(id, ownerId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error instanceof Error) {
                    if (error.message === roomServiceErrors_1.ROOM_SERVICE_ERRORS.ROOM_NOT_FOUND_OR_NO_PERMISSION_DELETE ||
                        error.message === roomServiceErrors_1.ROOM_SERVICE_ERRORS.CANNOT_DELETE_ROOM_WITH_BOOKINGS ||
                        error.message === roomServiceErrors_1.ROOM_SERVICE_ERRORS.ROOM_NOT_FOUND) {
                        throw error;
                    }
                }
