...
const rejectionPaymentProofEmail_1 = require("../../templates/email/rejectionPaymentProofEmail");
const bookingCancelationEmail_1 = require("../../templates/email/bookingCancelationEmail");
class EmailService {
    constructor() {
    ...
    sendBookingRejection(user, bookingDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const htmlContent = (0, rejectionPaymentProofEmail_1.createPaymentProofRejectionTemplate)(user, bookingDetails);
                yield this.sendEmail({
                    to: user.email,
    ...
    sendBookingCancelationByUser(user, bookingDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const htmlContent = (0, bookingCancelationEmail_1.createBookingCancellationByUserTemplate)(user, bookingDetails);
                yield this.sendEmail({
                    to: user.email,
    ...
    sendBookingCancelationByOwner(user, bookingDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const htmlContent = (0, bookingCancelationEmail_1.createBookingCancellationByOwnerTemplate)(user, bookingDetails);
                yield this.sendEmail({
                    to: user.email,
                    subject: 'Booking Cancelation - ProRent',
                    html: htmlContent
