...
exports.getMonthPeriodKey = getMonthPeriodKey;
exports.getYearPeriodKey = getYearPeriodKey;
function getMonthPeriodKey(startDate, endDate) {
    ...
    const isEndOfMonth = endDay.getUTCFullYear() === lastDayOfMonth.getUTCFullYear() &&
...
function getYearPeriodKey(startDate, endDate) {
    if (!startDate || !endDate) {
        return null;
    }
    const start = new Date(startDate);
