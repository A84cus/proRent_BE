...
function filterAndSortProperties(propertyMap, roomTypeMap, // Not directly used for linking anymore, but might be needed for other checks
reservations, // Might be used for complex sorting, but not for linking room types
filters, options) {
    ...
    if (filters.roomTypeId || filters.roomTypeSearch) {
        properties = properties.map(propSummary => {
            ...
            return Object.assign(Object.assign({}, propSummary), { roomTypes: filteredRoomTypes // Use the filtered list
             });
        });
