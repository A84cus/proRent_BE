...
const propertyRepository_1 = __importDefault(require("../repository/propertyRepository"));
const categoryRepository_1 = __importDefault(require("../repository/categoryRepository"));
const logger_1 = __importDefault(require("../utils/logger"));
const propertyServiceErrors_1 = require("../constants/propertyServiceErrors");
            ...
            try {
                ...
                if (error instanceof Error &&
                    (error.message ===
                        ...
                        error.message === propertyServiceErrors_1.PROPERTY_SERVICE_ERRORS.CANNOT_DELETE_PROPERTY_WITH_BOOKINGS)) {
                    throw error;
                }
